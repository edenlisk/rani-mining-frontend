...
const ListModalContainerHeader = ({ title, subTitle, navtext,open,table,isAlowed }) => {
        ...
        <>
         <PiCaretLeftLight className="mb-1" onClick={()=>navigate(-1)}/>
            <div className="sm:flex sm:justify-between sm:items-center mb-9">
               ...
               {isAlowed?<div className="py-[10px] px-[20px] rounded shadow-md shadow-[#A6A6A6] bg-custom_blue-500  hover:bg-custom_blue-600 flex items-center gap-3" onClick={open} >
